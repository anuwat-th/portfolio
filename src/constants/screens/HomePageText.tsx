...
export const translations = {
    ...
    heroDescriptionText:{
        ...
        th: `ผมเป็นนักพัฒนาส่วนหน้า (Frontend) และนักออกแบบ UX&UI ผมมีความถนัดในการสร้างเว็บไซต์และแอปพลิเคชันบนสมาร์ทโฟนด้วยเฟรมเวิร์ก React และ React Native`,
    },
    heroButton: {
        en: `See Work`,
        th: `ดูผลงาน`,
    ...
    bioContent1Text:{
        ...
        th: `ผมเป็นนักพัฒนาส่วนหน้า (Frontend) และนักออกแบบ UX&UI ผมเชื่อว่าการออกแบบส่วนหน้านั้นมีความสำคัญอย่างมากในโลกที่เชื่อมต่อกันด้วยอินเทอร์เน็ตในปัจจุบัน การออกแบบส่วนหน้าไม่เพียงแต่นำเสนอฟังก์ชันการทำงานเท่านั้น แต่ยังรวมถึงวิสัยทัศน์และเอกลักษณ์ของแบรนด์ ทำให้มันเป็นมากกว่าพิกเซลบนหน้าจอ`,
    },
    bioContent2Text:{
        en: `I’ve studying in Computer Science at Khon Kaen University in Thailand. I've experience with React&React Native frameworks and I specialize in UX&UI design,I’ve experienced with using tools like Figma.`,
